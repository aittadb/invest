...
const COOKIE_VALUE_MAX_LENGTH = 2_176;
// Covers the full actor and origin contracts while keeping one proof cookie below 4 KiB.
const COOKIE_PLAINTEXT_MAX_BYTES = 1_600;
