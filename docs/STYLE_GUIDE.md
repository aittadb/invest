...
- Do not load third-party runtime fonts, tracking scripts, analytics SDKs, or external client scripts. Owner-configured campaign images may use reviewed HTTPS URLs; consider their host, retention, and visitor-IP exposure before publication.
